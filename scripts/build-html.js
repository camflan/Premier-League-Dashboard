...
// The seasons list shown in the dashboard is derived from on-disk data.
// "YYYY-YY" labels sort correctly as plain strings.
const seasons = [
...
const activeShortSlash = active.slice(2).replace('-', '/'); // "2025-26" → "25/26"
